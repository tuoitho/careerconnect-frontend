...
import { FaPlus, FaEdit, FaUpload, FaLink, FaTrash, FaTimes } from 'react-icons/fa';
                ...
                <>
                    ...
                    {isEditing ? (
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        {(selectedLogo || company.logo) && (
                                            <img
                                                src={selectedLogo ? URL.createObjectURL(selectedLogo) : company.logo}
                                                alt="Current logo"
                                                className="w-16 h-16 object-cover rounded"
                                            />
                                        )}
                                        <label
                                            className="cursor-pointer bg-gray-100 px-4 py-2 rounded hover:bg-gray-200 transition-colors">
                        ...
                        <div className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <h3 className="font-medium mb-2 text-gray-700">Company Name</h3>
                                ...
                                <div>
                                    <h3 className="font-medium mb-2 text-gray-700">Address</h3>
                                    <p className="text-gray-900">{company.address || 'No address provided'}</p>
                                </div>

                                <div>
                                    <h3 className="font-medium mb-2 text-gray-700">Website</h3>
                                    {company.website ? (
                                        <a
                            ...
                            <div className="mt-8 pt-6 border-t border-gray-200">
                                ...
                                <form onSubmit={handleInvite} className="flex gap-4 max-w-xl">
                                    <input
                                        type="email"
